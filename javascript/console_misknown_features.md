...
![Fibonacci profiling on IE](console_misknown_features/fibonacci_ie.png)
*On IE*
![Fibonacci profiling on IE](console_misknown_features/fibonacci_chrome.png)
*On Chrome*
...
![Simple table](console_misknown_features/table_simple.png)
...
![Filtered table](console_misknown_features/table_filter.png)
...
![Stack trace](console_misknown_features/stack.png)
